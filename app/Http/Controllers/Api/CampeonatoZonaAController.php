...
use App\Models\Sancion; // Asegúrate de tener esta línea al inicio
use Illuminate\Http\Request;

class CampeonatoZonaAController extends Controller
{
    public function tablaGeneralAdultos(Request $request)
    {
        ...
        $partidosAdultos = Partido::with(['clubLocal', 'clubVisitante'])
            ...
            ->where('tipo_campeonato_id', $zonaA)
            ->get();

        // Damas fuera de Zona A (tipo_serie_id = 3)
        ...
        // Sumar damas si el club también está en Adultos Zona A
